...
<head>
    ...
    <title>Lupa Password | KlinikKita</title>
        ...
        <div class="w-full max-w-md overflow-hidden rounded-2xl bg-white shadow-2xl">
            <div class="p-8 md:p-12">
                <div class="mb-8 text-center">
                    ...
                    <p class="text-gray-500 mt-1">Masukkan nomor HP Anda yang terdaftar.</p>
                </div>
                ...
                <form action="<?= base_url('auth/lupa-password') ?>" method="post" class="space-y-6">
                    <?= csrf_field() ?>
                    <div>
                        ...
                        <div class="relative mt-1">
                            ...
                            <input type="tel" name="no_hp" id="no_hp" class="block w-full rounded-md border-gray-300 py-3 pl-10 pr-3 shadow-sm focus:border-sky-500 focus:ring-sky-500 sm:text-sm" required>
                        </div>
                    </div>
