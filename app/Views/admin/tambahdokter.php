    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-md-10 p-4">
                <h2 class="mb-4 text-center">Tambah Dokter Baru</h2>
                    ...
                    <div class="card-body">
                        <form method="post" action="<?= base_url('/admin/simpandokter'); ?>">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" name="username" id="username" class="form-control" placeholder="Username login dokter" required>
                            </div>

                            <div class="mb-3">
                                <label for="password" class="form-label">Password</label>
                                <input type="password" name="password" id="password" class="form-control" placeholder="Password login dokter" required>
                            </div>
